...
public class Celebrity extends AppCompatActivity {
    ...
    QuestionLibrary3 mQuestionLibrary = new QuestionLibrary3();
...
//    private int mScore = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScoreView = (TextView)findViewById(R.id.score3);
        mQuestionView = (TextView)findViewById(R.id.question3);
        rbnRadio1 =(RadioButton)findViewById(R.id.celeb1);
        rbnRadio2 =(RadioButton)findViewById(R.id.celeb2);
        rbnRadio3 = (RadioButton)findViewById(R.id.celeb3);
        rbnRadio4 = (RadioButton)findViewById(R.id.celeb4);
    ...
    public void updateQuestions(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength()){
            ...
            Toast.makeText(Celebrity.this, "It was the last question!", Toast.LENGTH_SHORT);
            Intent intent = new Intent(Celebrity.this, FinalScore.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            ...
            Toast.makeText(Celebrity.this, "Correct!", Toast.LENGTH_SHORT);
        }else
            Toast.makeText(Celebrity.this, "Wrong!", Toast.LENGTH_SHORT);
        // show current total score for the user
        updateScore(MainActivity.mScore);
